...
class AddNewStudent2 extends StatefulWidget {
  ...
  @override
  _AddNewStudent2State createState() => _AddNewStudent2State();
}
...
class _AddNewStudent2State extends State<AddNewStudent2> {
  ...
  validate() {
    if (formKey.currentState.validate()) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => Students2()));
    }
  }
      ...
      Timestamp dateOfBirth, String gender, String nextOfKin,String address,String grade) {
        ...
        try{
          String rollName = "$roll+$name";
           _firestore.collection('student2').document(rollName).setData({
          'name':name,
          'roll':roll,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Add Student for class 2'),
      ),
