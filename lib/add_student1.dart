...
//import 'package:firebase_auth/firebase_auth.dart';
var studentId;
class AddNewStudent1 extends StatefulWidget {
  static final id = 'newStudent';
  
  @override
  _AddNewStudent1State createState() => _AddNewStudent1State();
}

class _AddNewStudent1State extends State<AddNewStudent1> {
  ...
  validate() {
    if (formKey.currentState.validate()) {
      ...
      Navigator.push(context, MaterialPageRoute(builder: (context) => Students1()));
    }
  }
      ...
      Timestamp dateOfBirth, String gender, String nextOfKin,String address,String grade) {
        ...
        try{
          String rollName = "$roll+$name";
           _firestore.collection('student1').document(rollName).setData({
          'name':name,
          'roll':roll,
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Add Student for class 1'),
      ),
