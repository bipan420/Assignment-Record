...
class TeacherStudent1 extends StatefulWidget {
  static final id = 'TeacherStudent1';

  @override
  _TeacherStudent1State createState() => _TeacherStudent1State();
}

class _TeacherStudent1State extends State<TeacherStudent1> {
  @override
