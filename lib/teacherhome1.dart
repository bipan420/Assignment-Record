import 'package:asignment_record_system/assignment_history1.dart';
...
class TeacherHome1 extends StatefulWidget {
  static final id = 'TeacherHome1';

  @override
  _TeacherHome1State createState() => _TeacherHome1State();
}

class _TeacherHome1State extends State<TeacherHome1> {
      ...
      body: Container(
        child: Column(
          children: <Widget>[
            ...
            Text('Teacher Name: Ramesh Shrestha',style: TextStyle(fontSize: 20,color: Colors.blue),),
            Text('Subject: English',style: TextStyle(fontSize: 20,color: Colors.blue),),
