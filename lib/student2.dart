...
import 'package:asignment_record_system/add_student2.dart';
...
class Students2 extends StatefulWidget {
  static final id = 'Students2';

  @override
  _Students2State createState() => _Students2State();
}

class _Students2State extends State<Students2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Class 2'),),
        floatingActionButton: FloatingActionButton(
          child: Icon(Icons.add),
          onPressed: () {
            //Navigator.pushNamed(context, AddNewStudent.id);
            Navigator.push(context,
                MaterialPageRoute(builder: (context) => AddNewStudent2()));
          },
        ),
        body: SafeArea(
                  child: Container(
